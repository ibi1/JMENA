...
public class DateTimeUtil {
    ...
    public static String getDayOfWeek(String date) {
    	...
    	String sYear = StringUtil.getLeft(date, 4);
		String sMonth = StringUtil.getMid(date, 5, 2);
		String sDay = StringUtil.getRight(date, 2);
	...
	public static String getParseDateString(String date, String delimiter) {
		if ( !StringUtil.isLengh(date, 8) ) { return ""; }

		return StringUtil.getLeft(date, 4) + delimiter + StringUtil.getMid(date, 5, 2) + delimiter + StringUtil.getRight(date, 2);
	}
	...
	public static String getParseTimeString(String time, String delimiter) {
		if ( !StringUtil.isLengh(time, 6) ) { return ""; }
		return StringUtil.getLeft(time, 2) + delimiter + StringUtil.getMid(time, 3, 2) + delimiter + StringUtil.getRight(time, 2);
	}
	...
	public static String getParseTimeStampString(String time, String timedelimiter, String milliseconddelimiter) {
		if ( !StringUtil.isLengh(time, 9) ) { return ""; }
		return StringUtil.getLeft(time, 2) + timedelimiter + StringUtil.getMid(time, 3, 2) + timedelimiter + StringUtil.getMid(time, 5, 2) + milliseconddelimiter + StringUtil.getRight(time, 3);
	}
	...
	public static boolean isDate(String date) {
		...
		int nYear = Integer.parseInt(StringUtil.getLeft(date, 4));
		int nMonth = Integer.parseInt(StringUtil.getMid(date, 5, 2));
		int nDay = Integer.parseInt(StringUtil.getRight(date, 2));
	...
	public static String getMilliSecondToTimeStampString(int millisecond, String timedelimiter, String milliseconddelimiter) {
		...
		if ( tmpStr.length() > 3 ) {
			retStr = getSecondToTimeString(Integer.parseInt(StringUtil.getLeft(tmpStr, tmpStr.length() - 3)), timedelimiter);
			retStr += milliseconddelimiter + StringUtil.getMid(tmpStr, tmpStr.length() - 2, tmpStr.length() - (tmpStr.length() - 3));
		} else {
			
			
			if ( StringUtil.isLengh(tmpStr, 1) ) {
				tmpStr = StringUtil.getLPad(tmpStr, "0", 3);
			} else if ( StringUtil.isLengh(tmpStr, 2) ) {
				tmpStr = StringUtil.getLPad(tmpStr, "0", 2);
			}
	...
	public static int getTimeStringToSecond(String time) {
		if ( !StringUtil.isLengh(time, 6) ) { return 0; }
		
		int nRet = 0;
		
		int nHour = Integer.parseInt(StringUtil.getLeft(time, 2));
		int nMinute = Integer.parseInt(StringUtil.getMid(time, 3, 2));
		int nSecond = Integer.parseInt(StringUtil.getRight(time, 2));
	...
	public static int getTimeStampStringToMilliSecond(String timestamp) {
		if ( !StringUtil.isLengh(timestamp, 9) ) { return 0; }
		return (getTimeStringToSecond(StringUtil.getLeft(timestamp, 6)) * 1000) + Integer.parseInt(StringUtil.getRight(timestamp,3));
	}
	...
	public static String getAddYear(String date, int amount) {
		...
		sMonth = StringUtil.getLPad(sMonth, "0", 2);
		sDay = StringUtil.getLPad(sDay, "0", 2);
	...
	public static int getDateDiff(String date_1, String date_2) {
		...
		nYear = Integer.parseInt(StringUtil.getLeft(date_1, 4));
		nMonth = Integer.parseInt(StringUtil.getMid(date_1, 5, 2));
		nDay = Integer.parseInt(StringUtil.getRight(date_1, 2));
		
		Calendar sCal = Calendar.getInstance();
		sCal.set(nYear, nMonth - 1, nDay );

		nYear = Integer.parseInt(StringUtil.getLeft(date_2, 4));
		nMonth = Integer.parseInt(StringUtil.getMid(date_2, 5, 2));
		nDay = Integer.parseInt(StringUtil.getRight(date_2, 2));
	...
	public static int getDateTimeDiff(String startdatetime, String enddatetime) {
		...
		int nDay = getDateDiff(StringUtil.getLeft(startdatetime, 8), StringUtil.getLeft(enddatetime, 8));
		int nTime = getTimeDiff(StringUtil.getRight(startdatetime, 6), StringUtil.getRight(enddatetime, 6));
	...
	public static int getDateTimeStampDiff(String startdatetime, String enddatetime) {
		...
		int nDay = getDateDiff(StringUtil.getLeft(startdatetime, 8), StringUtil.getLeft(enddatetime, 8));
		int nTime = getTimeStampDiff(StringUtil.getRight(startdatetime, 9), StringUtil.getRight(enddatetime, 9));
