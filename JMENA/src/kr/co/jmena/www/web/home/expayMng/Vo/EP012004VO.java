...
public class EP012004VO {
	...
	public String getS_TAXGUBUN() {
		return this.S_TAXGUBUN;
	}
	public void setS_TAXGUBUN(String s_TAXGUBUN) {
		this.S_TAXGUBUN = s_TAXGUBUN;
	}
