package kr.co.jmena.www.web.home.expayMng.Vo;
...
public class EP011001VO {
	...
	public String getS_SALEDATESYM() {
		return S_SALEDATESYM;
	}
	public void setS_SALEDATESYM(String s_SALEDATESYM) {
		this.S_SALEDATESYM = s_SALEDATESYM;
	}
	public String getS_SALEDATEEYM() {
		return S_SALEDATEEYM;
	}
	public void setS_SALEDATEEYM(String s_SALEDATEEYM) {
		this.S_SALEDATEEYM = s_SALEDATEEYM;
	}
	...
	public String getSALERNM() {
		return SALERNM;
	}
	public void setSALERNM(String sALERNM) {
		this.SALERNM = sALERNM;
	}
