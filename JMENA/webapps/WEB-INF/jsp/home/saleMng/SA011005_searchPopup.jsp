...
<title>JMENA</title>
	...
	<script type="text/javascript">
		...
		function f_selectListEnaSaleMstPopup(SALEDATE){
			...
			$('#leftList').jqGrid({
				url:"/home/SA011005_selectListEanSaleMstPopup.do" ,
				datatype:"json",
				mtype: 'POST',
				postData : {
					SALEDATE : SALEDATE
				...
				colModel:[
					...
					{name:"SALEAMT",		index:'SALEAMT',		width:100,	align:'center',	sortable:false, formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0,defaultValue: ''}},
					{name:"SALEDANGA",		index:'SALEDANGA',		width:100,	align:'center',	sortable:false, formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0,defaultValue: ''},	hidden:true},
					...
					{name:"DCAMT",			index:'DCAMT',			width:100,	align:'center',	sortable:false, formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0,defaultValue: ''},	hidden:true},
					{name:"SELLAMT",		index:'SELLAMT',		width:100,	align:'center',	sortable:false, formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0,defaultValue: ''}},
					{name:"AGENCYAMT",		index:'AGENCYAMT',		width:100,	align:'center',	sortable:false, formatter:'currency', formatoptions:{thousandsSeparator:",", decimalPlaces: 0,defaultValue: ''},	hidden:true},
