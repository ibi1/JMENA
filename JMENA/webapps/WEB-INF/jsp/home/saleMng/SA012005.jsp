	...
	function f_selectListSA012005(S_IPGUMDATE_FR, S_IPGUMDATE_TO, S_BRANCHCODE, S_SALERCD, S_IPGUMGUBUN, S_IPGUMPERSON, S_IPGUMAMT){
        ...
        $("#mainList").jqxGrid({
            ...
            columns: [
				...
				{ text: '입금금액',			datafield: "IPGUMAMT",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
				{ text: '수금처리금액',		datafield: "SUMSUGUMAMT",	width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
				{ text: '처리잔액',			datafield: "JANGUMAMT",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
				...
				{ text: '계약면적',			datafield: "CONM2",			width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
				{ text: '계약평수',			datafield: "CONPY",			width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
				{ text: '입금 구분',		datafield: "DEPOSITGUBUN",	width: 80, cellsalign: 'center', align: 'center'},
				{ text: '수금금액',			datafield: "SUGUMAMT",		width: 180, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
