...
<title>Insert title here</title>
	...
	<script type="text/javascript">
		...
		function f_selectListEnaSaleMst(){
			...
			$('#leftList').jqGrid({
				url:"/home/SA011005_selectListEanSaleMst.do" ,
				datatype:"json",
				mtype: 'POST',
				postData : {
				...
				onSelectRow: function(ids){
					...
					$.ajax({ 
						type: 'POST' ,
						url: "/home/SA011005_selectDataSaleHistoryTb004.do", 
						dataType : 'json' ,
						data : {
		...
		function f_selectListEnaIpgumScheduleTb(SALEID){
			...
			$('#bottomList1').jqGrid({
				url:"/home/SA011005_selectListEnaIpgumScheduleTb.do" ,
				datatype:"json",
				mtype: 'POST',
				postData : {
					SALEID : SALEID
		...
		function f_selectListEnaJointNameTb(SALEID){
			...
			$('#bottomList2').jqGrid({
				url:"/home/SA011005_selectListEnaJointNameTb.do" ,
				datatype:"json" ,
				mtype: 'POST',
				postData : {
					SALEID : SALEID
		...
		function f_selectListEnaSaleHistoryTb(SALEID) {
			...
			$('#bottomList3').jqGrid({
				url:"/home/SA011005_selectListEnaSaleHistoryTb.do" ,
				datatype:"json" ,
				mtype: 'POST',
				postData : {
					SALEID : SALEID
			...
			$("#deleteButton").click(function() {
				...
				if (confirm("삭제하시겠습니까?") == true) {
					$.ajax({ 
						...
						url: "/home/SA011005_deleteDataSaleMst.do", 
						dataType : 'json' , 
						success: function(data){
		...
		$(function() {
			$("#saveButton").click(function() {
				...
				if (confirm(msg) == true) {
					...
					$.ajax({ 
						type: 'POST' ,
						data: $("#SA011005").serialize(),
						url: "/home/SA011005_insertDataSaleMst.do", 
						dataType : 'json' , 
						success: function(data){
		...
		$(function() {
			$("#searchPopButton").click(function() {
				...
				//팝업
				var popUrl = "/home/SA011005_searchPopup.do";	//팝업창에 출력될 페이지 UR
		...
		$(function() {
			$("#searchManageNoPopButton").click(function() {
				...
				//팝업
				var popUrl = "/home/SA011005_searchManagePopup.do";	//팝업창에 출력될 페이지 UR
				var popOption = "width=1300, height=600, resizable=no, scrollbars=no, status=no;";    //팝업창 옵션(optoin)
				window.open(popUrl,"매출관리",popOption);
			});
		})
			...
			$("#tab1DeleteButton").click(function() {
				...
				if (confirm("삭제하시겠습니까?") == true) {
					$.ajax({ 
						...
						url: "/home/SA011005_deleteDataEnaIpgumScheduleTb.do", 
						dataType : 'json' , 
						success: function(data){
							alert(data.resultMsg);
			...
			$("#tab1SaveButton").click(function() {
				...
				if (confirm(msg) == true) {
					...
					$.ajax({ 
						type: 'POST' ,
						data: formData,
						url: "/home/SA011005_insertDataEnaIpgumScheduleTb.do", 
						dataType : 'json' , 
						success: function(data){
							$("#S_FLAG_R_1").val("U");
			...
			$("#tab2DeleteButton").click(function() {
				...
				if (confirm("삭제하시겠습니까?") == true) {
					$.ajax({ 
						...
						url: "/home/SA011005_deleteDataEnaJointNameTb.do", 
						dataType : 'json' , 
						success: function(data){
							alert(data.resultMsg);
			...
			$("#tab2SaveButton").click(function() {
				...
				if (confirm(msg) == true) {
					...
					$.ajax({ 
						type: 'POST' ,
						data: formData,
						url: "/home/SA011005_insertDataEnaJointNameTb.do", 
						dataType : 'json' , 
						success: function(data){
							$("#S_FLAG_R_2").val("I");
			...
			$("#tab3SaveButton").click(function() {
				...
				if (confirm(msg) == true) {
					...
					$.ajax({ 
						type: 'POST' ,
						data: formData,
						url: "/home/SA011005_insertDataEnaSaleHistoryTb.do", 
						dataType : 'json' , 
						success: function(data){
							$("#S_FLAG_R_3").val("U");
		...
		$(function() {
			$("#SALERNAME").keydown(function() {
				...
				if(keyCode==13 || keyCode==9) {
					...
					$.ajax({ 
						type: 'POST' ,
						url: "/home/SA011005_selectHRInsamstBranchCode.do", 
						data : {
		...
		// 입금처리 팝업
		function fnProcDepositPopup(id) {
			var oRowData = $("#bottomList1").jqGrid("getRowData", id);
