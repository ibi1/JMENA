	...
	function f_selectListSA012003(S_DCODE, S_SALEDATE_FR, S_SALEDATE_TO, S_BRANCHCODE, S_DEPTCODE, S_KNAME){
        ...
        $("#mainList").jqxGrid({
            ...
            columns: [
				...
				{ text: '차입금액', 	datafield: "BRROWAMT",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '지급이율(%)', 	datafield: "PAYRATE",		width: 150, cellsalign: 'center', align: 'center'},
				{ text: '지급이자', 	datafield: "PAYAMT",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '이자소득세', 	datafield: "TAXAMT",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '실 수령액', 	datafield: "JIGUEBAMT",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
