	...
	function f_selectListSA012002(S_SALEDATE_FR, S_SALEDATE_TO, S_BRANCHCODE, S_DEPTCODE, S_DCODE, S_KNAME){
        ...
        $("#mainList").jqxGrid({
            ...
            columns: [
				...
				{ text: '원 판매가', 		datafield: "SALEAMT",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '할인율(%)', 		datafield: "DCRATE",		width: 150, cellsalign: 'center', align: 'center'},
				{ text: '실판매가', 		datafield: "SELLAMT",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '평단가', 			datafield: "SALEDANGA",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '위탁수수료', 		datafield: "AGENCYAMT",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '계약금', 			datafield: "DEPOSITAMT1",	width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '중도금', 			datafield: "DEPOSITAMT2",	width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '잔금', 			datafield: "DEPOSITAMT3",	width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '계약입금액', 		datafield: "SUGUMAMT1",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '중도입금액', 		datafield: "SUGUMAMT2",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
				{ text: '잔금입금액', 		datafield: "SUGUMAMT3",		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'f0'},
