	...
	function f_selectListSA012007(S_CITYCODE, S_BOROUGHCODE, S_ADDRESS){
        ...
        $("#mainList").jqxGrid({
            ...
            columns: [
				...
				{ text: '잔여면적',			datafield: "REMNM2",			width: 100, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
				{ text: '잔여평수',			datafield: "REMNPY",			width: 100, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
				{ text: '평단가',			datafield: "BUYDANGA",			width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
