		...
		function f_selectListMM012001(S_CITYCODE, S_BOROUGHCODE, S_ADDRESS){
	        ...
	        $("#mainList").jqxGrid({
	            ...
	            columns: [
	              ...
	              { text: '면적(m2)',	datafield: 'BUYM2', 		width: 100, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
	              { text: '평수',		datafield: 'BUYPY', 		width: 100, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
	              { text: '분양평수',	datafield: 'BUNBUYPY', 		width: 100, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
	              { text: '잔여평수',	datafield: 'JANBUYPY', 		width: 100, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
	              { text: '매매대금',	datafield: 'BUYAMT', 		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
	              { text: '계약금',		datafield: 'PAYAMT1', 		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
	              { text: '계약일',		datafield: 'PAYDATE1', 		width: 150, cellsalign: 'center', align: 'center' },
	              { text: '중도금1',	datafield: 'PAYAMT2', 		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
	              { text: '중도일1',	datafield: 'PAYDATE2', 		width: 150, cellsalign: 'center', align: 'center' },
	              { text: '중도금2',	datafield: 'PAYAMT3', 		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
	              { text: '중도일2',	datafield: 'PAYDATE3', 		width: 150, cellsalign: 'center', align: 'center' },
	              { text: '잔금액',		datafield: 'PAYAMT4', 		width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
	              { text: '잔금일', 	datafield: 'PAYDATE4', 		width: 150, cellsalign: 'center', align: 'center' },
	              { text: '잔금누계', 	datafield: 'JANPAYAMT', 	width: 150, cellsalign: 'right', align: 'center', cellsformat: 'c3'},
