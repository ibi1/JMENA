...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#bottomDiv').jqxSplitter({ theme: 'bootstrap', width: 990, height: 650, orientation: 'horizontal', resizable: false, splitBarSize: 0, showSplitBar: false, panels: [{ size: 430, collapsible: false}] });  
		...
		$("#BUYID").jqxInput({theme: 'energyblue', height: 25, width: 100, minLength: 1});
		$("#MANAGENO").jqxInput({theme: 'energyblue', height: 25, width: 100, minLength: 1});
		$("#ADDRESS").jqxInput({theme: 'energyblue', height: 25, width: 100, minLength: 1});
		...
		$("#BUYM2").jqxNumberInput({theme: 'energyblue', height: 23, width: 94, decimalDigits: 0, inputMode: 'simple'});
		$("#BUYPY").jqxNumberInput({theme: 'energyblue', height: 23, width: 94, decimalDigits: 0, inputMode: 'simple'});
		$("#BUNYM2").jqxNumberInput({theme: 'energyblue', height: 23, width: 94, decimalDigits: 0, inputMode: 'simple'});
		$("#BUNJANM2").jqxNumberInput({theme: 'energyblue', height: 23, width: 94, decimalDigits: 0, inputMode: 'simple'});
		$("#BUNYPY").jqxNumberInput({theme: 'energyblue', height: 23, width: 94, decimalDigits: 0, inputMode: 'simple' });
		$("#BUNJANPY").jqxNumberInput({theme: 'energyblue', height: 23, width: 94, decimalDigits: 0, inputMode: 'simple' });
		$("#BUYAMT").jqxNumberInput({theme: 'energyblue', height: 23, width: 94, decimalDigits: 0, inputMode: 'simple' });
		$("#BUYDANGA").jqxNumberInput({theme: 'energyblue', height: 23, width: 94, decimalDigits: 0, inputMode: 'simple'});
